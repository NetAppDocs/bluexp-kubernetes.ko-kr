...
Trident 운영자를 사용해 구축된 Astra Trident의 호환 버전을 사용하면 를 사용하여 Kubernetes 클러스터를 직접 관리할 수 있습니다 link:https://docs.netapp.com/us-en/cloud-manager-setup-admin/index.html["BlueXP"^] (이전의 Cloud Manager).
