...
[role="lead"]
BlueXP(Cloud Manager)의 Kubernetes의 새로운 기능에 대해 알아보십시오.
...
* link:https://docs.netapp.com/us-en/cloud-manager-kubernetes/task/task-kubernetes-discover-openshift.html["OpenShift 클러스터를 Cloud Manager로 가져옵니다"]
